...
Strong “M.2 accelerator module” posture, but lifecycle status matters.
...
- **Ara‑2 M.2 Module**
  - **Keying:** **M-key**
  - **Performance (claimed):** up to ~40 eTOPS
  - **Memory:** 8 GB or 16 GB LPDDR4 (variant-dependent)
  - **Host interface:** PCIe (vendor materials describe higher-gen PCIe)
  - **Lifecycle status:** preproduction in some published materials (validate at procurement time)
...
- **Metis AI Platform M.2**
  - **Tier:** high
  - **Performance (claimed):** ~214 TOPS (INT8) in published briefs
...
- **Metis AI Platform M.2 Max**
  - **Tier:** higher
  - **Performance (claimed):** (variant-dependent)
  - **Matchbox socket fit:** **Unknown / validate** (confirm keying and SKU availability)
...
- **SAKURA‑II M.2 module**
  - **Tier:** high
  - **Performance (claimed):** ~60 TOPS class positioning
  - **Form factor:** marketed as M.2 (often described as 2280 M-key in some materials)
  - **Memory variants:** vendor materials describe DRAM-equipped module options (validate per SKU)
  - **Matchbox socket fit:** **Unknown / validate** (confirm exact keying + power + availability)
...
- NXP Kinara Ara module pages: https://www.nxp.com/
- Axelera AI product briefs: https://axelera.ai/
- EdgeCortix product materials: https://www.edgecortix.com/
