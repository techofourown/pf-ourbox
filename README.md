...
- **[Tinderbox](hw/tinderbox/)** — Jetson Orin Nano/NX (SoM) model (formerly called Cinderbox; old name now reserved) ([[model:tinderbox]])
...
- **Family:** OurBox
- **Model:** Matchbox (`MBX`) / Tinderbox (`TBX`) / Woodbox (`WBX`) — size/form-factor class
