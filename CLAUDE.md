...
- **SKU / part numbers**: `TOO-<FAM>-<MODEL>-<TRIM>-<SEQ>` (e.g., `TOO-OBX-MBX-BASE-001`). All SKU/part numbers MUST start with `TOO-`; legacy SKU and CFG prefixes are banned.
